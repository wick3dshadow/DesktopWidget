...
public final class VerticalAppTray extends AppTray {
    ...
    public void init() {
        ...
        VerticalTabPane tabPane = new VerticalTabPane(VerticalTabPane.Side.LEFT, 83, 300);
        // add draggable title
    ...
    private VerticalTab createTab1(VerticalTabPane tabPane) {
        ...
        info.widthProperty().set(tabPane.getPrefWidth() - 10);
        info.heightProperty().set(tabPane.getPrefHeight());
        info.heightProperty().bind(tabPane.heightProperty());
        ...
        dragStagePane.setLayoutY(300);
        dragStagePane.layoutYProperty().bind(tabPane.heightProperty());
    ...
    private VerticalTab createTab3(VerticalTabPane tabPane) {
        VerticalTab tab = new VerticalTab("Settings", 1, tabPane);
        Pane tabContent = new Pane();
        setStyle("-fx-background-color: transparent;");
