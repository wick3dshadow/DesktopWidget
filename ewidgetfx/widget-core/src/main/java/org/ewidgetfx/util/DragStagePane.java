...
public final class DragStagePane extends Pane {
    ...
    protected EventHandler<MouseEvent> mouseDragged = e -> {
        ...
        /*System.out.println("draggableStage.getX() : " + draggableStage.getX());
        System.out.println("previousLocation.getX() : " + previousLocation.getX());
        System.out.println("e.getScreenX() : " + e.getScreenX());
        System.out.println("e.getX() : " + e.getX());
        System.out.println("anchorPt.getX() : " + anchorPt.getX());
        ...
        if(draggableStage.getX() >= (bounds.getWidth() - 83)){
        	//setLayoutY(bounds.getHeight());
        	draggableStage.setHeight(bounds.getHeight());
        	//setLayoutY(bounds.getHeight());
        	//draggableStage.getScene().getRoot().getUserData();
        	System.out.println("draggableStage.getHeight() : " + draggableStage.getHeight());
        	System.out.println("originalHeight : " + draggableStage.getHeight());
        }
        else{
        	draggableStage.setHeight(originalHeight);
        	//setLayoutY(originalHeight);
        	System.out.println("draggableStage.getScene().getHeight() NE : " + draggableStage.getScene().getHeight());
        	System.out.println("originalHeight NE : " + draggableStage.getHeight());
        }
    };
